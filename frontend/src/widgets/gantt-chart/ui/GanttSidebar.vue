...
<template>
    <aside class="w-72 p-5 shrink-0 border-r border-white/10 bg-dark-gray flex flex-col gap-16">
        <div class="flex flex-col">
            <h2 class="text-white font-bold font-montserrat text-[28px]">Задачи команды</h2>
        ...
        <div class="flex flex-1 flex-col gap-6 overflow-y-auto">
            <div class="flex gap-2">
                ...
                />
                <app-button :disabled="!newSprintName.trim()" size="sm" @click="createSprint">
                    +
                </app-button>
            </div>

            <div class="flex flex-1 flex-col gap-3">
                <div v-for="sprint in sprintsStore.sprints.value" :key="sprint.id" class="">
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            <span class="text-[10px] pb-3 text-gray-400"
                                >({{ sprint.tasks.length }})</span
                            >
                        </button>
                ...
                <p v-if="!sprintsStore.sprints.value.length" class="text-xs text-gray-400 italic">
