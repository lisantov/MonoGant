    ...
    >
        <div class="flex w-full justify-between items-center">
            ...
            <div class="flex gap-4">
                ...
                >
                    <app-icon name="trashcan" class="text-error" />
                </div>
            </div>
        </div>
        <span class="border border-light-gray" />
        <div class="grid grid-cols-3 gap-6">
            <div class="card">
                <div class="flex justify-between">
                    <p>Участники</p>
                    <div
                        class="min-w-5 min-h-5 flex justify-center rounded-xl p-2 bg-gray items-center"
                    >
                        <AppIcon name="people" />
                    </div>
                </div>
            ...
            <div class="card">
                <div class="flex justify-between">
                    <p class="text-sm">Ответственный</p>
                    <div
                        class="min-w-5 min-h-5 flex justify-center rounded-xl p-2 bg-gray items-center"
                    >
                        <AppIcon name="responsible" />
                    </div>
                </div>
                <p class="text-xl">
                    {{ responsible }}
